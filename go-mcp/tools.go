...
type Args struct {
	Entity string         `json:"entity" jsonschema:"localize"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ListlocoSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "listloco_list",
		Description: "List records from Listloco. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "listloco_load",
		Description: "Load a single record from Listloco. " +
...
func runOp(client *sdk.ListlocoSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ListlocoSDK, name string) (sdk.ListlocoEntity, error) {
	switch strings.ToLower(name) {
	case "localize":
		return client.Localize(nil), nil
