...
ListLoco API client, generated from the OpenAPI spec.

The ListLoco API localizes e-commerce product listings into marketplace-compliant and glossary-consistent text, primarily for Amazon.

Learn more about ListLoco API at [listloco.hayasaka.app](https://listloco.hayasaka.app/).

This is an unofficial SDK for the ListLoco public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — Localize — that you
...
```bash
cd go-mcp && go build -o listloco-mcp .
```
...
```json
{
  "mcpServers": {
    "listloco": {
      "command": "/abs/path/to/listloco-mcp"
    }
  }
}
```
...
| --- | --- | --- |
| **Localize** | The Localize entity (create). | `/localize` |
...
```go
import sdk "github.com/voxgig-sdk/listloco-sdk/go"
...
Generated from the ListLoco API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).
