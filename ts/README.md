# Listloco TypeScript SDK



The TypeScript SDK for the Listloco API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Localize()` — each with a small set of operations (`create`)
...
```ts
const client = new ListlocoSDK({ apikey: '...' })
...
| `tester(testopts?, sdkopts?)` | `ListlocoSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `ListlocoSDK.test(testopts?, sdkopts?)` | `ListlocoSDK` | Create a test-mode client. |
...
| `client` | `client(): ListlocoSDK` | Return the parent SDK client. |
...
Create an instance: `const localize = client.Localize()`
