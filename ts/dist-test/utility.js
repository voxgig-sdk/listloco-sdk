...
function envOverride(m) {
    if ('TRUE' === process.env.LISTLOCO_TEST_LIVE ||
        'TRUE' === process.env.LISTLOCO_TEST_OVERRIDE) {
    ...
    m.LISTLOCO_TEST_EXPLAIN = process.env.LISTLOCO_TEST_EXPLAIN || m.LISTLOCO_TEST_EXPLAIN;
    return m;
}
