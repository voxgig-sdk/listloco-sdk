...
// Listloco SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ListlocoMakeRequest
{
    public static function call(ListlocoContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ListlocoResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ListlocoResponse($fetched);
        } else {
