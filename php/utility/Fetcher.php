...
// Listloco SDK utility: fetcher

class ListlocoFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ListlocoSDK/1.0)';
    ...
    public static function call(ListlocoContext $ctx, string $fullurl, array $fetchdef): array
    {
