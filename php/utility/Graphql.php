...
class ListlocoGraphql
{
    ...
    // equivalent.
    public static function body(ListlocoContext $ctx): mixed
    {
    ...
    public static function errors(ListlocoContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
