...
{
    private static function utility(): ListlocoUtility
    {
        return new ListlocoUtility();
    }
    ...
    private static function ctx(array $over = []): ListlocoContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ListlocoContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ListlocoOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ListlocoError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ListlocoOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ListlocoMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ListlocoOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ListlocoMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ListlocoOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ListlocoMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ListlocoSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ListlocoMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ListlocoResponse([]),
            'result' => new ListlocoResult([]),
        ]);
        [, $err] = ListlocoMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ListlocoSpec([]),
            'response' => null,
            'result' => new ListlocoResult([]),
        ]);
        [, $err] = ListlocoMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ListlocoSpec(['step' => 's']),
            'response' => new ListlocoResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ListlocoResult([]),
        ]);
        [, $err] = ListlocoMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ListlocoSpec(['step' => 's']),
            'response' => new ListlocoResponse(self::resp(200, ['v' => 1])),
            'result' => new ListlocoResult([]),
        ]);
        [, $err] = ListlocoMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ListlocoSpec(['step' => 's']),
            'response' => new ListlocoResponse(self::resp(200, ['v' => 2])),
            'result' => new ListlocoResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ListlocoMakeResponse::call($ctx);
    ...
    {
        $preset = new ListlocoResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ListlocoSpec([]),
            'response' => new ListlocoResponse([]),
            'result' => new ListlocoResult([]),
        ...
        [$got, $err] = ListlocoMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ListlocoResult([])]);
        [, $err] = ListlocoMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ListlocoSpec([]), 'result' => null]);
        [, $err] = ListlocoMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ListlocoSpec(['step' => 's']),
            'result' => new ListlocoResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ListlocoOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ListlocoMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ListlocoSpec(['step' => 's']),
            'result' => new ListlocoResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ListlocoOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ListlocoMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ListlocoResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ListlocoSpec([]),
            'result' => new ListlocoResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ListlocoMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ListlocoMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ListlocoError('boom', 'boom');
        $utility->fetcher = function (ListlocoContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ListlocoSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ListlocoMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ListlocoContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ListlocoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ListlocoResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ListlocoContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ListlocoSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ListlocoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ListlocoResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ListlocoSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ListlocoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ListlocoMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ListlocoMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ListlocoResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ListlocoDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ListlocoResult(['ok' => false])]);
        $this->expectException(ListlocoError::class);
        ListlocoDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ListlocoResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ListlocoMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ListlocoMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ListlocoBaseFeature();
        $b = new ListlocoBaseFeature();
        ListlocoFeatureAdd::call($ctx, $a);
        ListlocoFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ListlocoBaseFeature
    {
        $f = new ListlocoBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ListlocoFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ListlocoContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ListlocoSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ListlocoPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ListlocoResponse(['headers' => null]),
            'result' => new ListlocoResult([]),
        ]);
        ListlocoResultHeaders::call($ctx);
