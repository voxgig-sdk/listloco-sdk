...
class ListlocoTestRunner
{
    ...
    {
        $live = self::getenv('LISTLOCO_TEST_LIVE');
        $override = self::getenv('LISTLOCO_TEST_OVERRIDE');
        ...
        $explain = self::getenv('LISTLOCO_TEST_EXPLAIN');
...
class_alias('ListlocoTestRunner', 'Runner');
class_alias('ListlocoHelpers', 'Helpers');
