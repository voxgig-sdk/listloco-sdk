...
// Listloco SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ListlocoSDK::test)
...
{
    private const SDK_CLASS = 'ListlocoSDK';
    ...
    private const SDK_BASE = 'listloco_sdk';
