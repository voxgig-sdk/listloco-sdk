...
// Listloco SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ListlocoOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ListlocoOmni::structfix($now, Struct::undef()))
                        !== json_encode(ListlocoOmni::structfix($val, Struct::undef()))) {
