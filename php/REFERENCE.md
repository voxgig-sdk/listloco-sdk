# Listloco PHP SDK Reference

Complete API reference for the Listloco PHP SDK.
...
#### `ListlocoSDK::test($testopts = null, $sdkopts = null)`
...
Create a new `LocalizeEntity` instance. Pass `null` for no initial data.

#### `options_map(): array`

Return a deep copy of the current SDK options.

#### `get_utility(): ListlocoUtility`
