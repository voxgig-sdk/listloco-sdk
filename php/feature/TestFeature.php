...
// Listloco SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ListlocoTestFeature extends ListlocoBaseFeature
{
    ...
    public function init(ListlocoContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ListlocoContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ListlocoContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ListlocoContext $ctx, $op, $args): array
    {
