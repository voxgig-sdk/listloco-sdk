...
class ListlocoTimeoutFeature extends ListlocoBaseFeature
{
    ...
    private function _with_timeout(ListlocoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ListlocoContext $_ctx, float $ms): void
    {
        $client = $this->client;
