...
func registerSDKWords(r *eng.Registry, client *sdk.ListlocoSDK) {
...
func runOp(client *sdk.ListlocoSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
