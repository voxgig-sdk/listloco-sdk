...
from listloco_sdk.listloco_types import (
    Localize,
    LocalizeCreateData,
)
...
class LocalizeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return LocalizeEntity(self._client, opts)
    ...
    def create(self, reqdata: LocalizeCreateData, ctrl=None) -> Localize:
        utility = self._utility
