...
from listloco_sdk.utility import register

# Load features
from listloco_sdk.feature.base_feature import ListlocoBaseFeature
from listloco_sdk.features import _has_feature, _make_feature
...
class ListlocoSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ListlocoUtility()
        self._utility = utility

        from listloco_sdk.config import shared_config
    ...
    def get_utility(self):
        return ListlocoUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ListlocoSDK: graphql: " + str(msg))
            res["graphql"] = errors

        return res


    def Localize(self, data=None) -> "LocalizeEntity":
        """Entity factory: client.Localize().list() / client.Localize().load({"id": ...})."""
        from listloco_sdk.entity.localize_entity import LocalizeEntity
        return LocalizeEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "ListlocoSDK":
        if sdkopts is None:
            sdkopts = {}
