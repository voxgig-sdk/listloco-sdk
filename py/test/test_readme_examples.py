# Listloco SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ListlocoSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ListlocoSDK(...) and ListlocoSDK.test(...) become
#      ListlocoSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "listloco_sdk"
_SDK_CLASS = "ListlocoSDK"
