...
The Python SDK for the Listloco API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Localize()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/listloco-sdk/releases)) or
...
client = ListlocoSDK({
    "apikey": os.environ.get("LISTLOCO_APIKEY"),
})
```
...
```
py/
├── listloco_sdk.py         -- Main SDK module
