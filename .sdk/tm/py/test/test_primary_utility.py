...
from projectname_sdk import ListlocoSDK
from projectname_sdk.core.spec import ListlocoSpec
from projectname_sdk.core.result import ListlocoResult
from projectname_sdk.core.response import ListlocoResponse
from projectname_sdk.core.operation import ListlocoOperation
from projectname_sdk.core.error import ListlocoError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import ListlocoBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = ListlocoSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = ListlocoSDK.test(None, None)
        ...
        class TestInitFeature(ListlocoBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ListlocoBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = ListlocoSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ListlocoSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ListlocoSDK.test(None, setup_opts)
