...
from projectname_sdk.core.control import ListlocoControl
...
class ListlocoContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, ListlocoResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ListlocoResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ListlocoError(code, msg, self)
