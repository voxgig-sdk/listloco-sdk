...
class ListlocoNetsimFeature extends ListlocoBaseFeature
{
    ...
    private function _simulate(ListlocoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ListlocoContext $ctx, array $applied): void
    {
        $client = $this->client;
