...
class ListlocoCacheFeature extends ListlocoBaseFeature
{
    ...
    private function _through(ListlocoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
