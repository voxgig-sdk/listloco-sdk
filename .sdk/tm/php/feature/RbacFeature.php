...
class ListlocoRbacFeature extends ListlocoBaseFeature
{
    ...
    private function _required(ListlocoContext $ctx): ?string
    {
    ...
    private function _reject(ListlocoContext $ctx, string $required): void
    {
    ...
    private function _track(ListlocoContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
