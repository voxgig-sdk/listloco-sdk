...
// Listloco SDK ratelimit feature
...
class ListlocoRatelimitFeature extends ListlocoBaseFeature
{
    ...
    private function _acquire(ListlocoContext $ctx): void
    {
    ...
    private function _track(ListlocoContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
