...
// Listloco SDK streaming feature
...
class ListlocoStreamingFeature extends ListlocoBaseFeature
{
    ...
    private function _iterate(ListlocoResult $result): \Generator
    {
    ...
    private function _streamable(ListlocoContext $ctx): bool
    {
