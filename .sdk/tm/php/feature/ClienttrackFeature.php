...
// Listloco SDK clienttrack feature
...
class ListlocoClienttrackFeature extends ListlocoBaseFeature
{
    ...
    public function PostConstruct(ListlocoContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Listloco-SDK';
