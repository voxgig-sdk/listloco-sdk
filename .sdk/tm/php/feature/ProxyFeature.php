...
class ListlocoProxyFeature extends ListlocoBaseFeature
{
    ...
    public function init(ListlocoContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ListlocoContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
