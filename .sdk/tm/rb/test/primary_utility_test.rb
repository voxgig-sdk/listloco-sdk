...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = ListlocoOmni.make_runner(TEST_JSON_FILE, ListlocoSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : ListlocoOmni.errify(err)
    end
