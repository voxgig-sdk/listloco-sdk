...
|---|---|---|
| `ts/` | @voxgig-sdk/listloco-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/listloco-sdk \
      --repository voxgig-sdk/listloco-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/listloco-sdk` shows it, and
`npm trust revoke @voxgig-sdk/listloco-sdk --id=<id>` removes it.
