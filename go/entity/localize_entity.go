...
type LocalizeEntity struct {
	name    string
	client  *core.ListlocoSDK
...
func NewLocalizeEntity(client *core.ListlocoSDK, entopts map[string]any) *LocalizeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LocalizeEntity) GetName() string { return e.name }
...
func (e *LocalizeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LocalizeEntity) Deleted() bool {
	return e.deleted
}


func (e *LocalizeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLocalizeEntity(e.client, opts)
}

func (e *LocalizeEntity) Data(args ...any) any {
...
func (e *LocalizeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Localize; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LocalizeEntity) DataTyped(data ...Localize) Localize {
	if len(data) > 0 {
		return typedFrom[Localize](e.Data(asMap(data[0])))
	}
	return typedFrom[Localize](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Localize (all fields
// optional at the wire level).
func (e *LocalizeEntity) MatchTyped(match ...Localize) Localize {
	if len(match) > 0 {
		return typedFrom[Localize](e.Match(asMap(match[0])))
	}
	return typedFrom[Localize](e.Match())
}
...
func (e *LocalizeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LocalizeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *LocalizeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *LocalizeEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LocalizeCreateData and returns an Localize. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *LocalizeEntity) CreateTyped(reqdata LocalizeCreateData, ctrl map[string]any) (Localize, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Localize{}, err
	}
	return typedFrom[Localize](res), nil
}



func (e *LocalizeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LocalizeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LocalizeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
